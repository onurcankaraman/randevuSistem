        ...
        <div class="container">
            ...
            <div class="tab-extra active" id="search-with-button">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    ...
                    <div class="float-sm-right"><a href="page-new-event.html" class="btn btn-primary pr-5 position-relative" style="height: 40px;">Add Event<span class="event-add-btn" style="height: 40px;"><i class="ri-add-line"></i></span></a></div>
                </div>
            </div>    
        </div>
    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body rounded work-detail work-detail-info">
                                        ...
                                        <div class="pt-2">
                                            <a href="page-workflow.html" class="btn btn-info mr-3 px-4">Use workflow</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body rounded work-detail work-detail-danger">
                                        ...
                                        <div class="pt-2">
                                            <a href="page-workflow.html" class="btn btn-danger mr-3 px-4">Use workflow</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body rounded work-detail work-detail-success">
                                        ...
                                        <div class="pt-2">
                                            <a href="page-workflow.html" class="btn btn-success mr-3 px-4">Use workflow</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body rounded work-detail work-detail-warning">
                                        ...
                                        <div class="pt-2">
                                            <a href="page-workflow.html" class="btn btn-warning mr-3 px-4">Use workflow</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body rounded work-detail work-detail-primary">
                                        ...
                                        <div class="pt-2">
                                            <a href="page-workflow.html" class="btn btn-primary mr-3 px-4">Use workflow</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
